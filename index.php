            ...
            <section>
                    ...
                    <div class="heading">
                     ...
                     <div class="news_1">
                         <div class="row form-group">
                             <div class="col-md-6" style="height: 315px; background-color: rgb(215, 207, 207); border-radius: 20px;box-shadow: 10px 10px 5px rgb(99, 166, 200);">
                                <h4>Giới thiệu về COVID-19</h4>
                                <p class="">COVID-19 (bệnh vi-rút corona 2019) là một bệnh do vi-rút có tên SARS-CoV-2 gây ra và được phát hiện vào ​​​​​ tháng 12 năm 2019 ở Vũ Hán, Trung Quốc. Căn bệnh này rất dễ lây lan và đã nhanh chóng lan ra khắp thế giới.</p>
                                <p class="">COVID-19 thường gây ra các triệu chứng hô hấp, có thể cảm thấy giống như cảm lạnh, cúm hoặc viêm phổi. COVID-19 có thể tấn công không chỉ phổi và hệ hô hấp của quý vị. Các bộ phận khác của cơ thể quý vị cũng có thể bị ảnh hưởng bởi căn bệnh này.</p>
                                <a href="" ><button type="button" class="btn btn-primary">Learn More</button> </a>
                             </div>
                             <div class="col-md-6">
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/AB3g8iyclG4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="border-radius: 20px;box-shadow: 10px 10px 5px rgb(99, 166, 200);"></iframe>
                             </div>
                         </div>
                     </div>
                     <div class="new_2" style="padding-top: 25px;">
                        <div class="row form-group">
                            <div class="col-md-3" >
                                ...
                                <a href="" style="color: black; "> <b> Cả nước ghi nhận 45.886 ca Covid-19 mới, 21 trường hợp tử vong</b></a>
                                </div>
                            </div>
                            <div class="col-md-3" >
                                <div id="news1">
                ...
                <div class="banner_form">
                    <div class="row form-group">
                        ...
                        <div class="col-md-4" >
                            <form class="">
                                <table style="width: 90%;background-color: aliceblue; margin-top: 30px; border-radius: 20px;" id="form">
                                    <tr>
                                        <td colspan="2"><h3 style="text-align: center; color: #157fda;border: 1px solid #157fda; border-radius: 20px;">Gửi yêu cầu điều trị</h3></td>
                                    </tr>
                                    <tr>
                                        <td>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <div id="benhvien_lv1">
                                ...
                                <br><p>Địa chỉ: 120 Hồng Bàng, Phường 12, Quận 5, TP.HCM</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div id="benhvien_lv1">
                ...
                <div class="phuongphap">
                    ...
                    <div class="row form-group" id="phuongphap1" style="margin-left: 0px;margin-right: 0px;padding-top: 0px;margin-bottom: 0px; padding-top: 40px;">
                ...
                <div class="thongke">
                    ...
                    <div  style="padding-top: 20px;">
                        <div>
                            <iframe src ="https://covid19.vnanet.vn/home/indexwigetsummary" frameborder="0" width="100%" style="min-height: 200px;" > </iframe>
                        </div>
                        <div>
